...
public enum JdbcType implements SQLType{
         ...
         */
        DATETIME("DATETIME", Types.TIMESTAMP, LocalDateTime.class, 0, JdbcType.IS_NOT_DECIMAL, 26L, "[(fsp)]"),
        /**
         * YEAR[(4)]
        ...
        /**
         * Get JdbcType matching the full MySQL type name, for example "DECIMAL(5,3) UNSIGNED ZEROFILL".
         * Distinct *_UNSIGNED type will be returned if "UNSIGNED" is present in fullJdbcTypeName.
         *
         * @param fullJdbcTypeName
        ...
        public static JdbcType getByName(String fullJdbcTypeName) {
            ...
            if (StringUtils.indexOfIgnoreCase(typeName, "DECIMAL") != -1 || StringUtils.indexOfIgnoreCase(typeName, "DEC") != -1
                ...
                return GEOMETRY; // TODO think about different JdbcTypes for Spatial Data Types
        ...
        public static JdbcType getByJdbcType(int jdbcType) {
            switch (jdbcType) {
                ...
                case Types.REF_CURSOR:
                    throw new IllegalStateException("REF_CURSOR type is not supported");
                case Types.TIME_WITH_TIMEZONE:
                    throw new IllegalStateException("TIME_WITH_TIMEZONE type is not supported");
                case Types.TIMESTAMP_WITH_TIMEZONE:
                    throw new IllegalStateException("TIMESTAMP_WITH_TIMEZONE type is not supported");
         ...
         *            params
         */
        private JdbcType(String JdbcTypeName, int jdbcType, Class<?> javaClass, int allowedFlags, boolean isDec, Long precision, String createParams) {
            this.name = JdbcTypeName;

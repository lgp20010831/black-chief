...
public class PackageUtils {
                            ...
                            if (name.startsWith(packageDirName)) {  
                                ...
                                if ((idx != -1) || recursive) {  
                                    ...
                                    if (name.endsWith(".class")  
                                        ...
                                        String forNameClass = packageName + '.' + className;
                                        try {  
                                            // 添加到classes  
                                            classes.add(Class.forName(forNameClass));
                                        } catch (Throwable e) {
                                            //log.debug("unload class: [{}]", forNameClass);
                                        }  
                                    }  
                                }  
                            }  
        ...
        for (File file : dirfiles) {  
            ...
            if (file.isDirectory()) {  
                ...
                try {  
                    ...
                    classes.add(Thread.currentThread().getContextClassLoader().loadClass(forNameClass));
    ...
    public static void main(String[] args) {
        ...
        ApplicationUtil.programRunMills(() -> {
            System.out.println(scanner.load("com").size());
        });

        ApplicationUtil.programRunMills(() -> {
            System.out.println(scan("com").size());
        });
	}
}

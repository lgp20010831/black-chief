...
public class ScriptRunner {
  ...
  private void executeFullScript(Reader reader) {
    ...
    try {
      ...
      throw new SQLSException(message, e);
    }
  }
  ...
  private void setAutoCommit() {
    try {
      ...
      throw new SQLSException("Could not set AutoCommit to " + autoCommit + ". Cause: " + t, t);
    }
  }
  ...
  private void commitConnection() {
    try {
      ...
      throw new SQLSException("Could not commit transaction. Cause: " + t, t);
    }
  }
  ...
  private void checkForMissingLineTerminator(StringBuilder command) {
    if (command != null && command.toString().trim().length() > 0) {
      throw new SQLSException("Line missing end-of-line terminator (" + delimiter + ") => " + command);
    }
  }

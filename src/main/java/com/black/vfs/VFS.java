...
public abstract class VFS {
  ...
  //直接 new VfsLoader 无法在 spring jar 包里成功扫描
  //所以最好选择 SpringBootVfsLoader
  public static VfsScanner findVfsScanner(){
    try {
      Class.forName("org.springframework.core.io.support.ResourcePatternResolver");
      return new SpringBootVfsLoader();
    } catch (ClassNotFoundException e) {
      return new VfsLoader();
    }
  }

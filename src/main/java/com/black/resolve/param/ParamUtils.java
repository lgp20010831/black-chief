...
public class ParamUtils {
    ...
    public static Class<?> getGenericByCollection(ParameterWrapper pw){
    ...
    public static boolean isCollection(ParameterWrapper pw){
        return Collection.class.isAssignableFrom(pw.getType());
    }

    public static boolean isMap(ParameterWrapper pw){
        return Map.class.isAssignableFrom(pw.getType());
    }

    public static Class<?>[] getGenericByMap(ParameterWrapper pw){
        Class<?>[] genericVals = ReflectionUtils.getMethodParamterGenericVals(pw.getParameter());
        if (genericVals.length == 0){

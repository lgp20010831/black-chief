...
public abstract class AbstractMapParamBodyHandler implements ParamBodyHandler{
    ...
    protected void processorMap(Map<String, Object> map){
        ...
        for (String key : keySet) {
            ...
            String ruacnlKey = handlerKey(key);
    ...
    abstract String handlerKey(String originKey);

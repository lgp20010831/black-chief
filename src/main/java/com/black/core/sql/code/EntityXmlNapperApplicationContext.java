...
public class EntityXmlNapperApplicationContext extends MapperXmlApplicationContext{

    private final EntityContextProxyManager contextProxyManager;

    public EntityXmlNapperApplicationContext(@NonNull GlobalSQLConfiguration configuration) {
        super(configuration);
